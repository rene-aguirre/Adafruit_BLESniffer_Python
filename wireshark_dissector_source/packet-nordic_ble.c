...
{
  {extern void proto_register_nordic_ble (void); proto_register_nordic_ble ();}
}

G_MODULE_EXPORT void
plugin_reg_handoff(void)
{
  {extern void proto_reg_handoff_nordic_ble (void); proto_reg_handoff_nordic_ble ();}
}
#endif
